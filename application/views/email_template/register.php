						...
						<tr>
							<td align="center" valign="top" class="imgHero"
								...
								style="text-decoration: none" target="_blank"><img alt=""
									...
									src="http://weekly.grapestheme.com/notify/img/hero/account-confirmation.png"
						...
						<tr>
							<td align="center" valign="top" class="description"
								style="padding-bottom: 40px; padding-left: 20px; padding-right: 20px;"><p
									...
									for signing up for Adhivakta Plus E-Diary account. We are happy
									to have you with us!</p></td>
						</tr>
						<tr>
							<td align="center" valign="top" class="subTitle"
								style="padding-bottom: 20px; padding-left: 20px; padding-right: 20px"><h4
									...
									style="color: #919191; font-family: 'Open Sans', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; font-style: normal; letter-spacing: normal; line-height: 26px; text-align: center; padding: 0; margin: 0">Verify
									Your Email Account</h4></td>
						</tr>
						<tr>
									...
									<tbody>
										<tr>
											<td align="center" class="postButton"
												...
												target="_blank" mc:edit="btnCard">Confirm Email</a></td>
										</tr>
									</tbody>
								</table></td>
						</tr>
						<tr>
							<td align="center" valign="top" class="description"
								style="padding-bottom: 40px; padding-left: 20px; padding-right: 20px;"><p
									...
									Or confirm using this link: <a href="<?php echo $verify_link?>"
										style="color: #8d6cd1" target="_blank"><?php echo $verify_link?></a>
								</p></td>
						</tr>
						<tr>
