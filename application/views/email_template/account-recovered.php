						...
						<tr>
							<td align="center" valign="top" class="description"
								style="padding-bottom: 40px; padding-left: 20px; padding-right: 20px;"><p
									...
									Your account password is successfully changed. Now you can login using your new password.   
									</p>
									</td>
						</tr>
						<tr>
									...
									<tbody>
										<tr>
											<td align="center" class="postButton"
												...
												target="_blank" mc:edit="btnCard">Login Using New Password</a></td>
										</tr>
									</tbody>
								</table></td>
						</tr>
						<tr>
							<td align="center" valign="top" class="description"
								style="padding-bottom: 40px; padding-left: 20px; padding-right: 20px;"><p
									...
									Please feel free to get in touch with us at info@adhivaktaplus.com if you want to to report any security concern.
								</p>
								<p>
								Thank you!<br>
								Adhivakta Plus Team
