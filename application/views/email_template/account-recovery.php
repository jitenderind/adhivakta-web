						...
						<tr>
							<td align="center" valign="top" class="description"
								style="padding-bottom: 40px; padding-left: 20px; padding-right: 20px;"><p
									...
									We have recived request to change password of your E-Diary account associated to your email <b><?php echo $email?></b>. Please click the button below and change password of your account.   
									</p>
									</td>
						</tr>
						<tr>
							<td align="center" valign="top" class="subTitle"
								style="padding-bottom: 20px; padding-left: 20px; padding-right: 20px"><h4
									...
									style="color: #919191; font-family: 'Open Sans', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; font-style: normal; letter-spacing: normal; line-height: 26px; text-align: center; padding: 0; margin: 0">Recover Account Password</h4></td>
						</tr>
						<tr>
									...
									<tbody>
										<tr>
											<td align="center" class="postButton"
												...
												target="_blank" mc:edit="btnCard">Recover Account Password</a></td>
										</tr>
									</tbody>
								</table></td>
						</tr>
						<tr>
							<td align="center" valign="top" class="description"
								style="padding-bottom: 40px; padding-left: 20px; padding-right: 20px;"><p
									...
									Please ignore this email if you didn’t request password recovery, please feel free to get in touch with us at info@adhivaktaplus.com to report this fake password recovery attempt.
								</p>
								<p>
								Thank you!<br>
								Adhivakta Plus Team
