...
class Ap_email extends CI_Email
{
    // DB table
    ...
    function sendEmail($emailArray, $type, $data = "",$attachment="")
    {
        ...
        $this->subject($emailArray['subject']);
        $header = $this->CI->load->view('email_template/email_header',$data,TRUE);
        $body = $this->CI->load->view('email_template/'.$type,$data,TRUE);
        $footer = $this->CI->load->view('email_template/email_footer',$data,TRUE);
